        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              {openRepairs} repairs, {openBuybacks} buy-backs
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Repair and buy-back metrics</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Open Buy-Back Requests</span>
