...
export default async function BuyBackPage() {
  ...
  return (
    <main className="flex flex-col gap-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Device Buy-Back</h1>
        <p className="text-muted-foreground">Manage customer device trade-in and buy-back requests</p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>All Buy-Back Requests</CardTitle>
          <CardDescription>Review device submissions and manage offers</CardDescription>
        </CardHeader>
        <CardContent>
          {buybacks.length === 0 ? (
            <div className="py-8 text-center text-muted-foreground">No buy-back requests yet</div>
          ) : (
