    ...
    <main className="min-h-screen bg-slate-50 text-slate-900 font-sans overflow-x-hidden selection:bg-violet-600 selection:text-white">
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="container mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img
              src="https://m.media-amazon.com/images/I/51WgWUay7CL.jpg"
      ...
      <section className="py-12 container mx-auto px-6 lg:px-12">
        <div className="bg-gradient-to-br from-violet-700 via-violet-800 to-slate-900 rounded-[3rem] p-8 md:p-16 lg:p-24 text-white relative overflow-hidden shadow-2xl">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mt-2 mb-6 leading-tight">
              Turn Your Old Gaming Device Into Value.
            </h2>
            <p className="text-violet-100 text-lg md:text-xl mb-12 font-medium max-w-2xl leading-relaxed">
            ...
            <div className="flex flex-wrap gap-3 md:gap-4 mb-12">
              {[
                ...
                <span
                  key={idx}
                  className="bg-white/10 backdrop-blur-md border border-white/20 px-4 md:px-5 py-2.5 rounded-full text-sm font-bold shadow-sm"
                >
                  {cat}
                </span>
              ))}
