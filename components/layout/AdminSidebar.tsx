...
const links = [["Dashboard","/admin/dashboard"],["Products","/admin/products"],["Orders","/admin/orders"],["Customers","/admin/customers"],["Repairs","/admin/repairs"],["Buy back","/admin/buy-back"],["Inventory","/admin/inventory"],["Reports","/admin/reports"]]
